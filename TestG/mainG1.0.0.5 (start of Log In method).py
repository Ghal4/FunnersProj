...
def LoggedInProtocole(LoggedUser):
    ...
    positionOfLoggedUserInFunnersContent = FunnersContent.index(LoggedUser)
    ...
    FunnersContent_LoggedUser = FunnersContent_LoggedUser.split('$')
    ...
    dict_user_content_description = {'CASH': 'the amount of money you have'
                                             'SHOP': 'presents available items for purchase'
                                                     'QUST': 'a quest you have to complete in order to get rewards'
                                                             'PLAY': 'play a game?'
                                                                     '2OUT': 'log out and go back to the home starting point'
                                                                             'READ': 'read st8u, read book, read sign... of someone'
                                                                                     'ST8U': 'st8tus - set a public status for your user'
                                                                                             'BOOK': 'publish your own book'  # and put it in store and get money
                                                                                                     'HOUS': 'get your own house!'
                                                                                                             'SIGN': 'put a sign on things for newcomers to observe'
                                                                                                                     'INV': ''}
    # honestly this would've been cool only 4 letters if I did not have the split method.

    dict_user_content_description = {  #######v#commands that only work alone#v#####
...
# 'as you break the stick a portion of white smokey thing comes out and disappears to the air. your progress has been saved!!'
...
# yo I have an idea
WorldMapTiles = ['Y2', '0forest', '1forest', '2forest', '3forest', '4forest', '5forest', '6forest', '7forest',
